...
export function BiometricMonitor({ onBreathingUpdate }: BiometricMonitorProps) {
  ...
  return (
    <div className="flex flex-col gap-4 items-center w-full">
      ...
      {!isMonitoring ? (
        <button onClick={startMonitoring} className="px-10 py-5 rounded-full bg-white/20 border-2 border-white/40 font-headline hover:bg-white/40 transition-all shadow-xl mt-4">CONNECT BIOMETRICS</button>
      ) : (
